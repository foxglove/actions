...
- If there is no review-body content, write exactly `No new findings.` Do not add meta commentary about the diff or the review itself (e.g. "net change is...", "nothing else to flag", "looks good").
