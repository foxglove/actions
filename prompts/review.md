...
- Migration and rollout risks: deploy order, compatibility, flags, backfills. If the PR introduces database migrations in the app repo, read packages/api/README.md#zero-downtime-migrations and assert that the migration follows those principles.
